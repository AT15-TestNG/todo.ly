...
public class GetDoneRootItemByChildIdTest {
    ...
    public void setup() {
        ...
        items.add(APIProjectMethods.createItem("Parent Item Test",null,4000128,true));
    ...
    @Test
    public void getDoneRootItemByChildID() {
        Item item = items.get(1);
        String doneRootItemByIdChildEndpoint = String.format(environment.getDoneRootItemByIdChildEndpoint(), item.getId());
        Response response = apiManager.get(doneRootItemByIdChildEndpoint);
